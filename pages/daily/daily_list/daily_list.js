// pages/daily/daily_list/daily_list.js
...
Page({
    ...
    async renderDailyList() {
        ...
        await this.setData({dailyList: dailylist});
    },
    async showinit() {
        await this.setData({
            dailyList: [],
    ...
    goTagList (e) {
        const Params = '?tag_id=' + e.currentTarget.dataset.id + '&tag_name=' + e.currentTarget.dataset.name;
        wx.navigateTo({
